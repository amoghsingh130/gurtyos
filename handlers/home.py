...
# too. Every screenshot renders full-width (a standalone image block) so dense captures
# stay legible — section-accessory thumbnails shrink them into unreadable smudges.
HOME_IMAGES = {
    "banner": {
...
def _feature(text: str, image_key: str) -> list[dict]:
    """A feature: the copy, then its screenshot full-width below it — legible, not a
    cramped right-side thumbnail."""
    img = HOME_IMAGES[image_key]
    return [
        {"type": "section", "text": {"type": "mrkdwn", "text": text}},
        {"type": "image", "image_url": img["url"], "alt_text": img["alt"]},
    ]
